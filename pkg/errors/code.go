...
var unknownCoder defaultCoder = defaultCoder{1, http.StatusInternalServerError, "An internal logicServer error occurred", ""}
...
// It will override the exist backend.
func Register(coder Coder) {
	if coder.Code() == 0 {
		panic("backend `0` is reserved by `github.com/ahang7/xxx/errors` as unknownCode error backend")
	}
...
func MustRegister(coder Coder) {
	if coder.Code() == 0 {
		panic("backend '0' is reserved by 'github.com/ahang7/xxx/errors' as ErrUnknown error backend")
	}
